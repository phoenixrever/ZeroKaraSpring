...
public class AwareInterfaceApplication {
    private static final Logger log = LoggerFactory.getLogger(AwareInterfaceApplication.class);
    ...
    public static void main(String[] args) {
        ...
        /*
            2. 有同学说:b、c、d 的功能用 @Autowired和@PostConstruct 就能实现啊, 为啥还要用 Aware 接口呢
            简单地说:
