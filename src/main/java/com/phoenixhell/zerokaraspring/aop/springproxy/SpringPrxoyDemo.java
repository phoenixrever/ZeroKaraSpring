...
public class SpringPrxoyDemo {
    public static void main(String[] args) {
        /*
            ...
            advisor = 更细粒度的切面，包含一个通知和切点 //不像aspect可以有多个 这个只有一个

            aspect 会被拆解成多个advisor
         */

        // 1. 备好切点  org.springframework.aop.Pointcut 的实现类 不要选错了
        AspectJExpressionPointcut pointcut = new AspectJExpressionPointcut();
        pointcut.setExpression("execution(* foo())");
        // 2. 备好通知 最重要的通知 其他通知类型都会转换成它  注意 不是Cglib 的 MethodInterceptor
